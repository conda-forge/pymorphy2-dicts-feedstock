...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9043&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymorphy2-dicts-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymorphy2-dicts` can be installed with:

```
conda install pymorphy2-dicts
```

It is possible to list all of the versions of `pymorphy2-dicts` available on your platform with:
